...
class Loglogin_model extends CI_Model{
    ...
    protected $column_order = ["timestamp", "ipaddress", "username", "status", "msg", "device", "user_agent"];
    protected $column_search = ["timestamp", "ipaddress", "username", "status", "msg", "device", "user_agent"];
